# Solana go-live checklist (Dexvra Trade Bot)
...
```
Then on the VPS: pull the dexvra repo, `cd tradebot && npm install` (pulls the Solana
deps — `@solana/web3.js`, `@solana/spl-token`, `bip39`, `bs58`, `ed25519-hd-key`), and
`pm2 restart dexvra-tradebot --update-env`.
